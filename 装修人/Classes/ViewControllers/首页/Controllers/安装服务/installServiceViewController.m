...
//
//  installServiceViewController.m
//  装修人
//
...
#import "Config.h"
#import "installServiceTableViewCell.h"
...
static NSString * cellidentitifir =@"installServiceTableViewCell";
@interface installServiceViewController () <UITableViewDelegate,UITableViewDataSource>
{
...
@implementation installServiceViewController
//延迟加载
...
-(void)initInterfaceView
{
    ...
    [self.aMytableView registerNib:[UINib nibWithNibName:@"installServiceTableViewCell" bundle:nil] forCellReuseIdentifier:cellidentitifir];
...
{
    installServiceTableViewCell * orderCell =[self.aMytableView dequeueReusableCellWithIdentifier:cellidentitifir];
    if (!orderCell) {
        orderCell = [[installServiceTableViewCell alloc]initWithStyle:UITableViewCellStyleValue1 reuseIdentifier:cellidentitifir];
    }
    return orderCell;
}
