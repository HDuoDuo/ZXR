...
#import "Config.h"
#import "lookDesignerTableViewCell.h"
...
static NSString * cellidentitifir =@"lookDesignerTableViewCell";
@interface lookDesignerViewController () <UITableViewDelegate,UITableViewDataSource>
{
...
@implementation lookDesignerViewController
//延迟加载
...
-(void)initInterfaceView
{
    ...
    [self.aMytableView registerNib:[UINib nibWithNibName:@"lookDesignerTableViewCell" bundle:nil] forCellReuseIdentifier:cellidentitifir];
...
{
    lookDesignerTableViewCell * orderCell =[self.aMytableView dequeueReusableCellWithIdentifier:cellidentitifir];
    if (!orderCell) {
        orderCell = [[lookDesignerTableViewCell alloc]initWithStyle:UITableViewCellStyleValue1 reuseIdentifier:cellidentitifir];
    }
    return orderCell;
}
